...
class _VideoPlayerScreenState extends ConsumerState<VideoPlayerScreen> {
    ...
    try {
      if (kIsWeb) {
        _videoPlayerController = VideoPlayerController.networkUrl(
          Uri.parse(widget.videoMedia.file.path),
        );
      } else {
        _videoPlayerController = VideoPlayerController.file(
          File(widget.videoMedia.file.path),
        );
      }
      ...
      ref
          ...
          .loadMetadata(widget.videoMedia.file);
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(playerNotifierProvider, (previous, next) {
      ...
      final justFinishedExtracting =
          (previous?.isExtracting == true) && !next.isExtracting;

      if (justFinishedExtracting &&
          next.extractedImage != null &&
          next.error == null) {
        if (_quickSave) {
          // Auto Save triggered by Quick Save
          ref
              .read(playerNotifierProvider.notifier)
              .saveImageToGallery(next.extractedImage!)
              .then((success) {
                if (success && mounted) {
      ...
      if (next.error != null) {
        ...
        if (next.error is FrameExtractionFailure) {
          message = AppLocalizations.of(context)!.frameExtractionError;
        } else if (next.error is SaveFailure) {
          message = AppLocalizations.of(context)!.saveFail;
        }
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: () =>
                                _seekRelative(const Duration(milliseconds: 33)),
                            icon: const Icon(
                                  ...
                                  children: [
                                    ...
                                    DropdownButtonHideUnderline(
                                      child: DropdownButton<ImageFormat>(
                                        ...
                                        items: _getAvailableFormats().map((
                                          format,
                                        ) {
                                    ...
                                    InkWell(
                                      onTap: () {
                                        final newQ = playerState.quality == 100
                                            ? 80
                                            : 100;
                                        ref
                                            .read(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: playerState.isExtracting
                              ? null
                              : () {
                                  _videoPlayerController.pause();
                                  _extractFrame();
